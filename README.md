...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/floral-darkness-dd241
```

A live public deployment of this template is available at [https://floral-darkness-dd241.templates.workers.dev](https://floral-darkness-dd241.templates.workers.dev)
